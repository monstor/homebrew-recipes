...
- **釀前把計畫寫成一行 `【預期】`**(放在「重力時間軸」欄):`【預期】DH1 Day 2-4 @1.040-1.030 | 撈袋+藍莓 Day 7-8 | 綠燈 Day 12-16 | 轉桶 Day 16-20 | FG 1.016-1.018 Day 12-16` → 圖上畫灰色「預期道」、圖下算「預期 vs 實際」Δ天/ΔSG,索引頁列 DH1/轉桶 Δ天。每批用誤差修正下一批的【預期】,讓預測收斂
