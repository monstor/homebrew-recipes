...
| IBU | ~25-30 |
| EBC | 12-14 |
| 基麥 | **Extra Pale Ale Malt 2.5kg**(+ Munich 1.0 + 小麥 1.0 + 燕麥 0.5)= 5.0kg |
...
> **注意:v2.5 尚未釀造。**本版已依 #0007/#0008 實飲回饋多次修訂(雙段乾投衝香、IBU 放回 25-30、Munich 補回守色澤、**最新:pH/石膏/糖化溫三改**)。
...
- **🍺 #0008 實飲回饋 → 最新修訂(降苦 + 果汁感)**:實飲「**有果汁感,但還是被大量苦味蓋過**」。關鍵:#0008 苦花只有 Magnum 6g 且準時加(無 #0007 那些失誤)→ **苦不是酒花量的問題**。四個真兇,逐一處理:
  ...
  - **9.8% 酒精灼熱感被讀成苦** → v2.5 降到 OG ~1.070 / **ABV ~7.0-7.4%**(5.0kg 穀物讓它比原計畫略滿,但遠低於 9.8%、仍清爽)
...
- **穀物**:**基麥 Extra Pale Ale Malt 2.5kg(這批實購,非 GP)** + 小麥 1.0kg + **燕麥 0.5kg 撐 haze**(視覺濃霧;#0008 是 0.8kg,減量控絲滑);不加 DME/Maltodextrin;**糖化維持 67°C**。**Extra Pale 2.5 / Munich 1.0 / Wheat 1.0 / 燕麥 0.5 = 5.0kg**
  - **🌾 基麥 Extra Pale vs Golden Promise**:Extra Pale 更乾淨中性,少了 GP 的餅乾麥甜與綿密酒體、色也略淡(EBC 落 ~12-14);走回 v2.3 的乾淨基底風。橘金色主要靠 Munich 1.0kg 撐
  - **🌫️ 霧度(視覺重點)**:小麥、GP 已採購定量(小麥 1.0kg),唯一可調的是燕麥 → **燕麥加回 0.5kg 補濃霧**(#0008 是 0.8kg,減量以控絲滑)。小麥+燕麥都給霧,燕麥額外帶絲滑,取半量是折衷
  - **🎨 Munich 維持 1.0kg(不砍半)**:實飲比較 **#0008(Munich 1.0kg、EBC 14-16)顏色明顯比 #0007 討喜**,而這支叫 **Orange Glow**,橘金色是本體。**色澤跟酒體是兩回事**——清爽感靠半量燕麥(0.5kg)/不加 DME/糖化平衡達成,不必犧牲顏色。EBC 13-15
...
- **數據**:OG **1.068-1.074**(5.0kg 穀物略滿;想更清爽加救援水)、FG **1.014-1.016**、ABV **~7.0-7.4%**、IBU ~25-30(成酒 pH 拉回後**感知苦度明顯下降**)、EBC 13-15、酒花總量 **202g**(Citra 84 / Galaxy 56 / **Mosaic 56** / Magnum 6)
...
- [ ] 麥芽(**總 5.0kg,無 DME**):**Extra Pale Ale Malt 2.5kg** + Munich Light **1.0kg**(色澤主力)+ Château Wheat Blanc **1.0kg** + **燕麥片 0.5kg**(加回撐霧)
