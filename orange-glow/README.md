...
| IBU | ~25-30 |
| EBC | 13-15 |
| 基麥 | Golden Promise 2.2kg(+ Munich 1.0 + 小麥 **1.2**,無燕麥)= 4.4kg |
...
- **穀物**:去燕麥(太絲滑)、**小麥拉到 ~27%(0.9→1.2kg)撐 haze**(Château Wheat Blanc);不加 DME/Maltodextrin;**糖化維持 67°C**(#0008 太乾太苦 → 果汁感需要殘糖墊住酒花,不再降到 65)。**GP 2.2 / Munich 1.0 / Wheat 1.2 = 4.4kg**
  - **🌫️ 霧度:去燕麥不會變清**——霧靠小麥+乾投,燕麥拿掉的是「絲滑口感」不是霧。為保證視覺濃霧,小麥 0.9→1.2kg(~27%);小麥給霧但不帶回絲滑,兩者分工
...
- **數據**:OG 1.062-1.066、FG **1.014-1.016**、ABV **~6.5-6.8%**、IBU ~25-30(但成酒 pH 拉回後**感知苦度會明顯下降**)、EBC 13-15、酒花總量 **202g**(Citra 84 / Galaxy 56 / **Mosaic 56** / Magnum 6)
- 微調:想更厚/更絲滑 → 燕麥加回 0.5-0.8kg(注意會回絲滑感);想更烈 → 補 DME 拉 OG;想更苦 → whirlpool 往 82°C 或苦花加到 8-10g;**想更香 → DH2 加到 84g**;**想更霧 → 小麥再加到 1.4kg(別加燕麥——燕麥給絲滑不是霧)**;想顏色更深 → Munich 加到 1.2-1.5kg
...
- [ ] 麥芽(**總 4.4kg,無燕麥、無 DME**):Golden Promise **2.2kg** + Munich Light **1.0kg**(色澤主力)+ Château Wheat Blanc **1.2kg**(~27%,haze 主力)
